...
class Config(SubModularSpark[T]):
    ...
    def __init__(
        ...
        super().__init__(file, k, epsilon, parse_func, func, empty_value, False)
        conf = pyspark.SparkConf().setAppName('MST_Algorithm').setMaster('local[1]')
